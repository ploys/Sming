...
#define  u5    1.256637061435917295385057353   /*  u5   2*pi/5                 */
#define  c5_1 -1.25                            /*  c5_1 (cos(u5)+cos(2*u5))/2-1*/
#define  c5_2  0.5590169943749474241022934171  /*  c5_2 (cos(u5)-cos(2*u5))/2  */
#define  c5_3 -0.9510565162951535721164393334  /*  c5_3 -sin(u5)               */
#define  c5_4 -1.538841768587626701285145288   /*  c5_4 -(sin(u5)+sin(2*u5))   */
#define  c5_5  0.3632712640026804429477333787  /*  c5_5 (sin(u5)-sin(2*u5))    */
				  ...
				  double yRe[], double yIm[])
{
	...
	double  ar0, ar1, ar2, ar3, ar4;
	double  ai0, ai1, ai2, ai3, ai4;
