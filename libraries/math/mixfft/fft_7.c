...
#define  c7_1  0.222520933956314404288902564496794759466355569
#define  c7_2  0.900968867902419126236102319507445051165919162
#define  c7_3  0.623489801858733530525004884004239810632274731
#define  c7_4  0.433883739117558120475768332848358754609990728
#define  c7_5  0.781831482468029808708444526674057750232334519
#define  c7_6  0.974927912181823607018131682993931217232785801
				  ...
				  double yRe[], double yIm[])
{
	...
	double are0, aim0, aRe[7], aIm[7];
	double are16add, are61sub, aim16sub, aim16add, are25add, are52sub, aim25sub, aim25add;
	double are34add, are43sub, aim34sub, aim34add;
	double ax, ay;
