...
#ifndef MATH_CORDIC32_H_
#define MATH_CORDIC32_H_
...
/**
 * The CORDIC function will expect a value from -pi/2 to pi/2.
 * Other values can be computed easily.
 * For pi/2--pi, the result is just (pi/2-(a-pi/2)) and similarly for -pi---pi/2.
 * Every other angle can be mapped into this range by taking the angle mod pi.
 */
